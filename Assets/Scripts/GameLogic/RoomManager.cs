...
public class RoomManager : MonoBehaviour
{
    ...
    public List<GameObject> pickupPrefabs; // Cofre o �tem aleatorio
    ...
    public void CheckEnemies(int roomID)
    {
        ...
        // Si no hay ning�n objeto con el tag "Enemy", entonces la sala est� limpia
    ...
    void SpawnPickup(Vector3 position)
    {
        ...
        // Instanciarlo en la posici�n dada
